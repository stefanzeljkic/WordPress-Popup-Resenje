<?php
/**
 * Plugin Name: WordPress Popup Resenje
 * Description: Top and bottom popup html and css. Supports top and bottom positions with separate settings. Support HTML + CSS content in popup.
 * Version: 1.0
